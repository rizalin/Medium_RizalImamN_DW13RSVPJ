      ...
      return (
        <div>
          <React.Fragment>
            ...
            <div className="kontainers" style={{ maxHeight: '55px', padding: '8px 0' }}>
              <Row>
                <Col md lg="2">
                ...
                <Col md lg="3" style={{ padding: "10px 0" }}>
                  <h5 style={{ color: '#757575', fontWeight: "normal" }}>MISSION ORIGINAL <span style={{ padding: "0 10px" }}>|</span>SUBSCRIBE</h5>
                </Col>
                <Col>
                </Col>
              </Row>
