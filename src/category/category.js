        ...
        <div className="kontainers" style={{ paddingTop: "30px" }}>
          <Media>
            ...
            <Col sm={5}>
              <h3 style={{ marginTop: "20px" }}>
                <span class="writerR">The front lines of the future.</span> A
                Medium publication about tech and science.
              </h3>
            </Col>
            <Col
              sm={{ offset: 3 }}
          ...
          <Media>
            ...
            <Media.Body className="textbody-L">
              <div>
                ...
                <p>
                  Game Worlds can be blueprints for real word, liberating spaces
                  where rules can be reinvited and the invisible made visible
                </p>
                <p>
                  <span class="writerL">Thomas McMullan</span>
                  <br></br>Dec 9 . 6 min read
                </p>
              </div>
            </Media.Body>
          </Media>
          ...
          <Media>
            <Media.Body className="textbody-R">
              ...
              <p>We have a few things to share</p>
              <p>
                <span class="writerR">Damon Beres</span>
                <br></br> Dec 3 . 6 min read
              </p>
            </Media.Body>
            <img
          ...
          <Media>
            ...
            />
            <Media.Body
              className="textbody-L"
              style={{ padding: "81px  50px" }}
            >
              <div>
                ...
                <p>
                  <span class="writerL">Owen Williams</span>
                  <br></br>Dec 10 . 5 min read
                </p>
              </div>
            </Media.Body>
          </Media>
          ...
          <div className="textbody-C">
            <div className="article" style={{ width: "58%" }}>
              <h1>
                "Even my oldest Echo, at five years old, works perfectly. This
                shouldn’t be a shocking revelation, but for a piece of
                technology these days, it is.”
              </h1>
              <h5
                className="blockquote-footer"
                style={{ fontSize: "15px", color: "black", marginTop: "10px" }}
              >
                Megan Morone
              </h5>
              <br></br>
