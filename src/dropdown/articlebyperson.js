            ...
            <div>
                ...
                <div className="article" style={{ paddingTop: '60px' }}>
                    <Row className="justify-content-between" style={{ marginBottom: '50px' }}>
                        <Col sm={10}>
                            <Row className="justify-content-left" style={{ alignItems: 'center', marginLeft: '0px' }}>
                                <h1>Ryan Holiday</h1>
                                <Button variant="outline-dark" size="sm" style={{ padding: '0px 10px' }}>Follow</Button>
                    ...
                    <div className="box">
                        <Row style={{ marginBottom: '25px' }}>
                            ...
                            <Col>
                                <p class="name">Ryan Holiday in Human Parts
                                <br></br>June 1, 2018 . 6 min read</p>
                            </Col>
                        </Row>
                        <img src='https://imgur.com/download/4xwzwta' style={{ marginBottom: '25px' }} />
                        <br></br>
                        <h2>How To Recover When The World Breaks You</h2>
                        <h4>We all break. The key is to become strong when broken...</h4>

                        <Row className='justify-content-between' style={{ width: '100%', marginTop: '20px' }}>
                    ...
                    <div className="box">
                        <Row style={{ marginBottom: '18px' }}>
                            ...
                            <Col>
                                <p class="name">Ryan Holiday in Human Parts
                                <br></br>Dec 14 . 6 min read</p>
                            </Col>
                        </Row>
                        <img src='https://imgur.com/download/3jT79wQ' style={{ marginBottom: '25px' }} />
