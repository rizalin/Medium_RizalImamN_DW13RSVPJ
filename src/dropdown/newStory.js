                ...
                <div>
                    <div className="story" >
                        <Row className='justify-content-between'>
                            <Col sm={2}>
                                <Row className="justify-content-between" style={{ alignItems: 'center', fontSize: "13px", maxWidth: '130px' }}>
                            ...
                            <Col sm={2}>
                                <Row className="justify-content-between" style={{ alignItems: 'center' }}>
                                    <Button variant="success" size="sm" className="publish">Publish</Button>
